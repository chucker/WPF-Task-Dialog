...
namespace TaskDialogInterop
{
    ...
    public struct TaskDialogOptions
    {
        ...
        /// <summary>
        /// The handle for the owner window of the task dialog box. Can be a WPF or Win32 (incl. Windows Forms) window.
        /// </summary>
        ...
        /// </summary>
        public System.Windows.Window OwnerWindow { set { Owner = new System.Windows.Interop.WindowInteropHelper(value).Handle; } }
